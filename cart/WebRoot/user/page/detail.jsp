...
<header id="top">
    ...
    <div class="rt">
        <ul class="lf">
            ...
            <li><a href="../web/ToCartServlet" >购物车</a><b>|</b></li>
...
<div id="shop_detail">
    ...
    <div id="preview" class="lf">
        ...
        <div id="icon_all">
            <ul id="icon_list">
                ...
                <li class="i1"><img src="../img/goods/${book.isbn }/detail2.jpg" onerror="this.style.display='none'" style="display: none;"/></li>
                <li class="i1"><img src="../img/goods/${book.isbn }/detail3.jpg" onerror="this.style.display='none'" style="display: none;"/></li>
                <li class="i1"><img src="../img/goods/${book.isbn }/detail4.jpg" onerror="this.style.display='none'" style="display: none;"/></li>
                <li class="li"><img src="../img/goods/${book.isbn }/detail5.jpg" onerror="this.style.display='none'" style="display: none;"/></li>
            </ul>
        </div>
    </div>
    <!-- 右侧-->
    <div class="right_detail lf">
        ...
        <div class="shops">
            ...
            <a href="#" class="collection lf" id="collect"><span>收藏</span></a><b><img src='../img/product_detail/product_detail_img6${(collect == null)?"":"2"}.png' alt=""/></b>
        </div>
    </div>
</div>
<!--为你推荐-->
...
<script>
    $(function () {
        ...
        $("#collect").click(function (){
           	...
           	$.ajax({
                type: "post",
                url: '../web/CollectServlet',
                data: "userId=${sessionScope.currentUser.phone}&product=${book.isbn}",//params,
                success: function (data) {
                    if (data == 'yes') {
                    	alert("操作完成！");
                    	window.location.href = "../web/ToDetailServlet?isbn=${book.isbn}";
                    } else {
                        alert("操作失败！");
                    }
                },
